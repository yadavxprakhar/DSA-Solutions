...
|----------|----------|---------|-----------|---------|-----------|
| ![LC](https://img.shields.io/badge/LeetCode-FFA116?style=flat-square&logo=leetcode&logoColor=white) LeetCode | — | 14 | 19 | 1 | **34** |
...
|--|----------|---------------|
| Problems | 34 (64%) | 19 (36%) |
| Easy | 14 | 11 |
| Medium | 19 | 6 |
| Hard | 1 | 0 |
| Basic (GFG) | — | 2 |

> 📦 **Total across both platforms: 53 problems solved**
<!-- PLATFORM:END -->
...
|---|---------|------------|-------|------|----------|
| 138 | 🟠 LC Copy List With Random Pointer | 🟡 Medium | Linked List | 2026-05-02 | [View →](https://github.com/yadavxprakhar/DSA-Solutions/blob/main/138-copy-list-with-random-pointer/copy-list-with-random-pointer.java) |
