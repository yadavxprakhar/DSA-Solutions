...
|----------|----------|---------|-----------|---------|-----------|
| ![LC](https://img.shields.io/badge/LeetCode-FFA116?style=flat-square&logo=leetcode&logoColor=white) LeetCode | — | 32 | 65 | 16 | **113** |
...
|--|----------|---------------|
| Problems | 113 (72%) | 43 (28%) |
| Easy | 32 | 16 |
| Medium | 65 | 17 |
| Hard | 16 | 2 |
| Basic (GFG) | — | 8 |

> 📦 **Total across both platforms: 156 problems solved**
<!-- PLATFORM:END -->
...
|---|---------|------------|-------|------|----------|
| 1234 | 🟠 LC Number Of Paths With Max Score | ⚪ Unknown | Graphs | 2026-07-05 | [View →](https://github.com/yadavxprakhar/DSA-Solutions/blob/main/1234-number-of-paths-with-max-score/number-of-paths-with-max-score.java) |
