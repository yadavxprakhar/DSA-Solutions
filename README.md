...
|----------|----------|---------|-----------|---------|-----------|
| ![LC](https://img.shields.io/badge/LeetCode-FFA116?style=flat-square&logo=leetcode&logoColor=white) LeetCode | — | 27 | 54 | 11 | **92** |
...
|--|----------|---------------|
| Problems | 92 (68%) | 43 (32%) |
| Easy | 27 | 16 |
| Medium | 54 | 17 |
| Hard | 11 | 2 |
| Basic (GFG) | — | 8 |

> 📦 **Total across both platforms: 135 problems solved**
<!-- PLATFORM:END -->
...
|---|---------|------------|-------|------|----------|
| 219 | 🟠 LC Contains Duplicate Ii | ⚪ Unknown | General | 2026-06-15 | [View →](https://github.com/yadavxprakhar/DSA-Solutions/blob/main/219-contains-duplicate-ii/contains-duplicate-ii.java) |
