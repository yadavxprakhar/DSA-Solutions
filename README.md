...
|----------|----------|---------|-----------|---------|-----------|
| ![LC](https://img.shields.io/badge/LeetCode-FFA116?style=flat-square&logo=leetcode&logoColor=white) LeetCode | — | 45 | 87 | 27 | **159** |
...
|--|----------|---------------|
| Problems | 159 (79%) | 43 (21%) |
| Easy | 45 | 16 |
| Medium | 87 | 17 |
| Hard | 27 | 2 |
| Basic (GFG) | — | 8 |

> 📦 **Total across both platforms: 202 problems solved**
<!-- PLATFORM:END -->
...
|---|---------|------------|-------|------|----------|
| 1776 | 🟠 LC Minimum Operations To Reduce X To Zero | ⚪ Unknown | General | 2026-09-23 | [View →](https://github.com/yadavxprakhar/DSA-Solutions/blob/main/1776-minimum-operations-to-reduce-x-to-zero/minimum-operations-to-reduce-x-to-zero.java) |
